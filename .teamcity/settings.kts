...
project {
    ...
    features {
        ...
        awsConnection {
            ...
            param("awsStsEndpoint", "https://sts.us-east-1.amazonaws.com")
            param("awsSessionCredentials", "false")
            param("awsRegionName", "us-east-1")
            param("awsAccessKeyId", "test")
            param("awsCredentialsType", "awsAccessKeys")
            param("secure:awsSecretAccessKey", "credentialsJSON:c0e43a4c-97f1-4a51-86e6-9b35f51b02e1")
        }
        awsConnection {
            id = "PROJECT_EXT_5"
            name = "TESTTTT"
...
object RunAwsCliCommand : BuildType({
    ...
    features {
        exposeAwsCredentialsToEnvVars {
            ...
            param("awsConnectionId", "PROJECT_EXT_4")
        }
    }
})
